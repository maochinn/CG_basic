...
void main()
{
    ...
    vec3 world_camera_pos = u_view[3].xyz;
    // Calculate the distance from the camera to the three control points
    // float EyeToVertexDistance0 = distance(gEyeWorldPos, WorldPos_ES_in[0]);
    // float EyeToVertexDistance1 = distance(gEyeWorldPos, WorldPos_ES_in[1]);
    // float EyeToVertexDistance2 = distance(gEyeWorldPos, WorldPos_ES_in[2]);
    float distance_0 = distance(world_camera_pos, c_out[0].world_pos)
    float distance_1 = distance(world_camera_pos, c_out[1].world_pos)
    float distance_2 = distance(world_camera_pos, c_out[2].world_pos)
